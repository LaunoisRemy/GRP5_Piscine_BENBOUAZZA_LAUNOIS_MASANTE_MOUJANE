...
urlpatterns = [
    ...
    path('espace_eleve', views.espace_eleve,name="statistiques"), # Ici le <int:id_eleve capture l'id de l'élève, et on en a besoin pour savoir les résultats de qui on veut afficher
