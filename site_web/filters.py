...
class FiltreNoteParPartie(django_filters.FilterSet):
    ...
    class Meta:
        model = ScoreParPartie
        fields = ['id_TOEICEnCours__id_TOEIC', 'id_Eleve__classe__lib_Classe','id_Eleve__groupe__lib_Groupe','id_Eleve__classe__annee_Promo','id_Eleve__nom','id_Eleve__prenom'
         ]
